...
object MenuSfx {
    ...
    fun load(context: Context) {
        ...
        packName.value = GeneralSettings.raw.getString(PackNameKey, null)
    ...
    fun importFromTree(context: Context, treeUri: Uri): Int {
        ...
        if (copied > 0) {
            ...
            packName.value = name
            GeneralSettings.raw.edit { putString(PackNameKey, name) }
            rebuildPool(context)
        }
        return copied
    }
    ...
    fun clear(context: Context) {
        ...
        packName.value = null
        GeneralSettings.raw.edit { remove(PackNameKey) }
