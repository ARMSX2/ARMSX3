...
class XmbGlView(context: Context) : TextureView(context), TextureView.SurfaceTextureListener {
    ...
    companion object {
        ...
        // ARMSX3 purple, to match the default Purple theme accent (0xFFC7A6FF).
        // ARMSX2's blue gradient is what made the library still look like ARMSX2
        // even after the accent changed. Linear 0..1 RGB, not sRGB bytes.
        private val BG_TOP = floatArrayOf(0.06f, 0.03f, 0.16f)
        private val BG_BOT = floatArrayOf(0.48f, 0.30f, 0.92f)
