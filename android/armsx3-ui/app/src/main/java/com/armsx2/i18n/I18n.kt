...
val EN: Map<String, String> = mapOf(
    ...
    "mods.discOnly" to "This game is a disc image, so there is nowhere to put mod files. Mods work on games installed from a package or kept as a game folder.",
    "mods.folder" to "Put mods here",
    "mods.empty" to "No mods yet. Make a folder inside the path above \u2014 one folder per mod \u2014 and lay the files out the way they sit inside the game. Each mod then appears here with a switch.",
