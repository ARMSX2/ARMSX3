...
val EN: Map<String, String> = mapOf(
    ...
    "packages.updates.description" to "Look up a game's official title updates and install them. Updates are what fix most games that boot to a black screen or crash early. The base game must already be installed.",
