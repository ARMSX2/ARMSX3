...
val EN: Map<String, String> = mapOf(
    ...
    "app.bg.flurry.desc" to "Use Calum Robinson's Flurry (2002) as the library backdrop instead of the wave. It is a live particle simulation, so it costs more than the still or the 2D wave \u2014 off by default for that reason. No effect if you've set a custom background image.",
