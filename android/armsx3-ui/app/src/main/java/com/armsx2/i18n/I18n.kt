...
val EN: Map<String, String> = mapOf(
    ...
    "mods.discOnly" to "This game is a disc image, so there is nowhere to put mod files.",
    "mods.requirement" to "Mods only work on games installed from a .pkg, or kept as a JB game folder. Disc images cannot be modded.",
    ...
    "mods.library.empty" to "No moddable games. A game has to be installed from a .pkg, or kept as a JB game folder, before it can take mods.",
