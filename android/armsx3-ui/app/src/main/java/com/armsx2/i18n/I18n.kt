...
val EN: Map<String, String> = mapOf(
    ...
    "app.trophySound.none" to "No sound set, so trophies unlock silently.",
    "app.trophySound.set" to "Trophy sound set.",
    "app.trophySound.failed" to "Could not use that file.",
    "app.menuSfx" to "Menu Sound Effects",
    "app.menuSfx.desc" to "Sound effects for menu actions: select, back, menu open, toggles, sliders. Comes with a built-in set, and a folder of named clips imported below replaces them.",
