...
val EN: Map<String, String> = mapOf(
    ...
    "info.dlc" to "Add-ons (DLC)",
    "info.dlc.count" to "%d installed",
    "info.dlc.none" to "None detected",
    ...
    "app.menuSfx.desc" to "Sound effects for menu actions: select, back, menu open, toggles, sliders. Comes with a built-in set, and a folder of named clips imported below replaces them. A clip named trophy is used for the sound played when you earn one, which has no built-in default.",
    ...
    "app.menuSfx.hint" to "Pick a folder with clips named nav, select, submenu, menu, back, toggle_on, toggle_off, reset, slider, sleep, wake (any of .ogg / .wav / .mp3). Keep them short, a fraction of a second. A clip named trophy plays when you earn one.",
    ...
    "app.gameFolders.add" to "Add Folder",
    "app.gameFolders.remove" to "Remove",
    ...
    "packages.updates.titleId" to "Title ID",
    "packages.updates.refresh" to "Refresh",
    "packages.updates.scanning" to "Checking %d of %d…",
    "packages.updates.noLibrary" to "No games with a title ID in your library yet.",
    "packages.updates.manual" to "Check another title",
    "packages.updates.rowUpToDate" to "up to date (%s)",
    ...
    "packages.updates.versions" to "Versions",
    "packages.updates.installThis" to "Install",
    "library.install.title" to "Install this game?",
    "library.install.message" to "%s is a package sitting in your games folder. Installing it copies the game into ARMSX3, and it becomes playable. Nothing is removed.",
    "library.install.deleteSource" to "Delete the .pkg afterwards",
    "library.install.running" to "Installing. This can take a few minutes for a large game.",
    "library.install.running.short" to "Installing",
    "packages.updates.current" to "Current",
    "packages.updates.removeUpdate" to "Remove update",
    "packages.updates.removeConfirm" to "Remove? Tap again",
    "packages.updates.removed" to "Update removed, back to the disc version.",
    ...
    "packages.updates.installedNow" to "Installed: version %s",
    "packages.updates.installedNone" to "No update installed",
    "packages.updates.alreadyHave" to "Installed",
    "packages.updates.reinstall" to "Reinstall",
    "packages.updates.upToDate" to "This game is already up to date.",
    "packages.updates.downloading" to "Downloading %s, %d%%",
    "packages.updates.installingOne" to "Installing %s",
    "packages.updates.version" to "Version %s",
    "packages.updates.firmware" to "needs firmware %s",
    "packages.updates.install" to "Install",
    ...
    "mods.remove" to "Remove",
    "mods.remove.title" to "Remove this mod?",
    "mods.remove.body" to "\"%s\" and its files will be deleted. Your game is not affected, nothing was ever copied into it. You can import the mod again later.",
    ...
    "renderer.blendingMode.auto" to "Auto",
    ...
    "savestate.wipe" to "Delete all savestates",
    "savestate.wipe.confirm.title" to "Delete every savestate?",
    "savestate.wipe.confirm.body" to "This removes the whole savestate folder, including files the manager cannot list. It cannot be undone.",
    "savestate.wipe.done" to "Deleted %d file(s), %s freed.",
    "savestate.wipe.partial" to "Deleted %d file(s), %s freed. %d could not be removed.",
